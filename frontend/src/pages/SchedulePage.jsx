    ...
    <div>
      ...
      {schedules.length === 0 ? (
        ...
        <div className="attendance-table">
          <div className="attendance-table-header" style={{ gridTemplateColumns: '90px 55px 55px 1fr 1fr 1fr' }}>
            <span>Date</span>
            <span>Start</span>
            <span>End</span>
            <span>Class</span>
              ...
              (function(sc) {
                ...
                for (var ssi = 0; ssi < students.length; ssi++) {
                  (function(st) {
                    ...
                    var isFirst = ssi === 0;
                    rows.push(
                      <div key={rowKey} className="attendance-table-row" style={{ gridTemplateColumns: '90px 55px 55px 1fr 1fr 1fr' }}>
